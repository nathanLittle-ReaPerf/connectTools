...
TYPE_LABELS: dict[str, str] = {
    ...
    "UpdateRecordingBehavior":     "Set Recording",
    "SetVoice":                    "Set Voice",
    ...
    "CheckMetricData":             "Check Metric",
    "WaitForCustomerInput":        "Wait for Input",
    "ConnectParticipantWithLexBot":"Lex Bot",
    "DisconnectParticipantWithExternalResource": "Disconnect (External)",
}
...
def _cond_label(condition: dict) -> str:
    ...
    mapping  = {
        ...
        "NumberGreaterThanOrEqualTo": ">=", "NumberGreaterOrEqualTo": ">=",
        "NumberLessThanOrEqualTo": "<=", "NumberLessOrEqualTo": "<=",
    }
